  ...
  return (
    <Card className="bg-[oklch(0.18_0.03_155)] border-amber-500/30">
      ...
      <CardContent className="space-y-4">
        {/* Main description */}
        <div className="p-3 rounded-md bg-[oklch(0.15_0.02_155)] border border-amber-500/20">
          <p className="text-xs text-gray-300 leading-relaxed">
            ...
            <code className="text-amber-400 bg-amber-500/10 px-1 py-0.5 rounded text-[11px] mx-1">demo_standard.py</code>
            can create real paid generation tasks if <code className="text-amber-400 bg-amber-500/10 px-1 py-0.5 rounded text-[11px]">ARK_API_KEY</code> is configured.
          </p>
        </div>

        {/* Official model IDs confirmation */}
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-2">
          <div className="bg-[oklch(0.15_0.02_155)] rounded-lg p-3 border border-emerald-500/20">
            <p className="text-xs font-bold text-emerald-400">Standard</p>
            <p className="text-[10px] text-gray-500 font-mono mt-1">dreamina-seedance-2-0-260128</p>
            <p className="text-[10px] text-gray-400 mt-1">Highest quality · 480p/720p/1080p/4k</p>
          </div>
          <div className="bg-[oklch(0.15_0.02_155)] rounded-lg p-3 border border-amber-500/20">
            <p className="text-xs font-bold text-amber-400">Fast</p>
            <p className="text-[10px] text-gray-500 font-mono mt-1">dreamina-seedance-2-0-fast-260128</p>
            <p className="text-[10px] text-gray-400 mt-1">Speed/cost balance · 480p/720p</p>
          </div>
          <div className="bg-[oklch(0.15_0.02_155)] rounded-lg p-3 border border-blue-500/20">
            <p className="text-xs font-bold text-blue-400">Mini</p>
            <p className="text-[10px] text-gray-500 font-mono mt-1">dreamina-seedance-2-0-mini-260615</p>
            <p className="text-[10px] text-gray-400 mt-1">Cheapest/testing · 480p/720p</p>
          </div>
        </div>
        ...
        <div className="p-3 rounded-md bg-emerald-500/5 border border-emerald-500/20">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-2 text-[11px]">
            <div><span className="text-gray-500">Model:</span> <span className="text-gray-300">Standard</span></div>
            <div><span className="text-gray-500">Mode:</span> <span className="text-gray-300">reference_mode</span></div>
          ...
          <CollapsibleContent className="pt-2">
            <div className="space-y-1.5">
              {quickstartChecklist.map((item, i) => (
                <div key={i} className="flex items-start gap-2 p-2 rounded-md bg-[oklch(0.15_0.02_155)] border border-emerald-500/10">
        ...
        <Collapsible open={showPhase6} onOpenChange={setShowPhase6}>
          ...
          <CollapsibleContent className="pt-2">
            <div className="p-3 rounded-md bg-[oklch(0.15_0.02_155)] border border-emerald-500/10 space-y-1">
